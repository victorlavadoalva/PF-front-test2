        ...
        <div className={styles.row}>
          ...
          <div className={styles.footer_col}>
            ...
            <ul>
              ...
              <li>
                <a href="https://pf-front-test2-production.up.railway.app/home/cart">
                  Carrito
                </a>
              </li>
            </ul>
          ...
          <div className={styles.footer_col}>
            ...
            <ul>
              <li>
                <a href="https://pf-front-test2-production.up.railway.app/home">
                  Restaurantes
                </a>
              </li>
              <li>
                <a href="https://pf-front-test2-production.up.railway.app/mapa">
